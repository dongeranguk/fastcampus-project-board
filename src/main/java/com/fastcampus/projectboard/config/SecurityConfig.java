...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(
            HttpSecurity http, OAuth2UserService<OAuth2UserRequest, OAuth2User> oAuth2UserService) throws Exception {
        return http
     ...
     *
     * @param userAccountService 게시판 서비스 사용자 계정을 다루는 서비스 로직
