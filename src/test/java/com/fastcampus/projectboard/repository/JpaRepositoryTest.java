...
class JpaRepositoryTest {
    ...
    void givenParentCommentId_whenSelecting_thenReturnsChildComments() {
        ...
        // When
        Optional<ArticleComment> parentComment = articleCommentRepository.findById(parentCommentId);
    ...
    void givenArticleCommentIdHavingChildCommentsAndUserId_whenDeletingParentComment_thenDeletesEveryComment() {
        ...
        // When
        articleCommentRepository.deleteByIdAndUserAccount_UserId(1L, "du");
    ...
    void givenHashtagNamesAndPageable_whenQueryingArticles_thenReturnsArticlePage() {
        ...
        assertThat(articlePage.getContent().get(0).getHashtags()).extracting("hashtagName", String.class).containsExactly("fuscia");
