...
class ArticleControllerTest {
    ...
    @Test
    public void givenPagingAndSortParams_whenSearchingArticlesView_thenReturnsArticlesView() throws Exception {
        // Given
        String sortName = "title";
        String diretion = "desc";
        int pageNumber = 0;
        int pageSize = 5;
        ...
        mvc.perform(get("/articles")
                        ...
                        .queryParam("sort", sortName + "," + diretion))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.TEXT_HTML))
                .andExpect(view().name("articles/index"))
                .andExpect(model().attributeExists("articles"))
    ...
    @WithUserDetails(value="duTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    @DisplayName("[view][GET] 새 게시글 등록 - 정상 호출")
    @Test
    public void givenNewArticleInfo_whenRequesting_thenSavesNewArticle() throws Exception {
        // Given
    ...
    @Test
    public void givenAuthorizedUser_whenRequesting_thenRedirectsToLoginPage() throws Exception {
        // Given
        long articleId = 1L;
    ...
    @Test
    public void givenUpdatedArticleInfo_whenRequesting_thenSavesUpdatedNewArticle() throws Exception {
        // Given
        long articleId = 1L;
        ArticleRequest articleRequest = ArticleRequest.of("new title", "new content");
