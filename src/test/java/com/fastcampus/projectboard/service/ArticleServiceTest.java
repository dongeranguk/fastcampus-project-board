...
class ArticleServiceTest {
    ...
    @Test
    public void givenNoSearchParameters_whenSearchingArticles_thenReturnArticlePage() {
        // Given
    ...
    @Test
    public void givenSearchParameters_whenSearchingArticles_thenReturnArticlePage() {
        // Given
    ...
    @Test
    public void givenNoSearchParameters_whenSearchingArticlesViaHashtag_thenReturnsEmptyPage() {
        // Given
    ...
    @Test
    public void givenHashtag_whenSearchingArticlesViaHashtag_thenReturnsArticlesPage() {
        // Given
    ...
    @Test
    public void givenArticleId_whenSearchingArticles_thenReturnArticle() {
        // Given
        Long articleId = 1L;
        Article article = createArticle();
    ...
    @Test
    public void givenNonexistentArticleId_whenSearchingArticles_thenThrowsException() {
        // Given
        Long articleId = 0L;
    ...
    @Test
    public void givenArticleInfo_whenSavingArticle_thenExtractsHashtagsFromContentAndSavesArticleWithExtractedHashtags() {
        // Given
        ...
        assertThat(article)
                ...
                .hasFieldOrPropertyWithValue("content", dto.content())
                        .extracting("hashtags", as(InstanceOfAssertFactories.COLLECTION))
                                .hasSize(1).extracting("hashtagName").containsExactly("springboot");
    ...
    @Test
    public void givenNonexistentArticleInfo_whenUpdatingArticle_thenLogsWarningAndDoesNothing() {
        // Given
        ArticleDto dto = createArticleDto("새 타이틀", "새 내용");
    ...
    @Test
    public void givenNothing_whenCountArticles_thenReturnsArticleCount() {
        // Given
        long expected = 0L;
